...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/freelancing`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${siteUrl}/digital-marketing`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${siteUrl}/data`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${siteUrl}/cybersecurity`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
