...
export const TRACK_ARTWORKS: Record<string, TrackArtwork> = {
  ...
  "winning-proposals-cold-emailing": {
  ...
  "global-invoicing-international-clients": {
  ...
  "business-model-canvas-monetization": {
  ...
  "pitch-decks-fundraising-basics": {
  ...
  "unit-economics-startup-finance": {
  ...
  "social-engineering-antiphishing": {
  ...
  "applied-cryptography-secure-comms": {
  ...
  "atomic-habits-relentless-focus": {
  ...
  "time-blocking-prioritization-eisenhower": {
  ...
  "energy-management-sleep-architecture": {
  ...
  "digital-minimalism-attention-protection": {
  ...
  "growth-mindset-psychological-grit": {
  ...
  "life-architecture-sustainable-harmony": {
