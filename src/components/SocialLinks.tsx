 ...
 *
 * Drawn as inline SVG rather than loaded from a CDN: the icons are four small
 * paths, and fetching them would cost a request each and a flash of nothing
 * while they arrive. They inherit `currentColor`, so one component works on the
 * light footer and on the brand-coloured panels without a second variant.
 *
 * Each link carries its own accessible name — a row of unlabelled icons is
 * read out as "link link link link" by a screen reader.
 */
const ICONS: Record<string, string> = {
  facebook:
    "M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.26h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z",
  tiktok:
    "M16.6 5.82A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5 2.59 2.59 0 1 1 .77-5.06V9.7a5.68 5.68 0 0 0-.77-.05 5.66 5.66 0 1 0 5.66 5.66V9.01a7.35 7.35 0 0 0 4.29 1.38V7.3a4.29 4.29 0 0 1-3.21-1.48z",
  instagram:
